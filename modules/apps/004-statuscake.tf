...
#     }
#     monitored_resource {
#         address = "https://argocd.${var.subdomain_prefix}.${var.root_domain}"
#     }
# }

# this was already setup by old cluster, if I need to change something in the future need to import it
...
resource "statuscake_uptime_check" "apps" {
    ...
    monitored_resource {
        address = "https://${each.key}.${var.subdomain_prefix}.${var.root_domain}"
    }
    contact_groups = [
        data.statuscake_contact_group.default.id
    ]
