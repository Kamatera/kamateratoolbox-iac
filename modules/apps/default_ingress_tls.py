...
def main(rancher_public_ip, root_domain, ssh_private_key_file, secret_name):
    if subprocess.call(["kubectl", "-n", "ingress-nginx", "get", "secret", secret_name]) == 0:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            subprocess.check_call([
                'kubectl', '-n', 'ingress-nginx', 'create', 'secret', 'tls', secret_name,
